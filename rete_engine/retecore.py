...
class InferenceEngine:
    ...
    def _select_production(self):
        ...
        return self.strategy.select(self.agenda)
...
# Example usage
def main():
    engine = InferenceEngine(GamblersBucketBrigade)
    ...
    production, token = engine._select_production()
    result = production.execute(token, engine)
